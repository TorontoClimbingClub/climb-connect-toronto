...
BEGIN
    ...
    (main_chat_id, admin_user_id, '🏔️ Welcome to the Toronto Climbing Club Main Chat! This is your space to discuss all things climbing in Toronto. Share meetups, news, and connect with fellow climbers!'),
    (outdoors_chat_id, admin_user_id, '🌲 Welcome to Outdoors Chat! Share outdoor climbing spots, route conditions, weather updates, and plan outdoor adventures with the community.'),
